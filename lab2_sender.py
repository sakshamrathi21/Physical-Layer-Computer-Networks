...
class Sender:
    ...
    def __init__(self, list_of_bitflips : list[float]) -> None:
        """Initialises the member variables of the class"""

        self.Sample_rate : int = 44100
        self.Bit_duration : float = 0.5
    ...
    def send_message(self, input_string : str):
        """
        ...
        crc_code = input_string + self.crc_remainder(input_string, self.CRC_polynomial, Initial_filler)
...
if __name__ == "__main__":
    ...
    s = Sender(list_of_indices)
    s.send_message(transmit_bitstring)